export class FormDataUtil {
    ...
    static toObject(formData) {
        const obj = {};
        const assignNestedValue = (target, keys, value) => {
            const lastKey = keys.pop();
            if (!lastKey)
                return;
            let current = target;
            for (const key of keys) {
                if (typeof current !== 'object' || current === null || current[key] === undefined || typeof current[key] !== 'object') {
     ...
     */
    static fromObject(obj, formData, namespace, seen = new WeakSet()) {
