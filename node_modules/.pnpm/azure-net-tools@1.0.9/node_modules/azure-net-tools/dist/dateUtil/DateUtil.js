...
export class DateUtil {
     ...
     */
    static setLocale(locale, customLocaleData) {
        this._locale = locale;
     ...
     */
    static getDateParts(date, utc = false) {
        const d = date instanceof Date ? date : new Date(date);
     ...
     */
    static toDateTime(date, utc = false) {
     ...
     */
    static toFullDateTimeNoTZ(date, utc = false) {
        if (!this.isValidDate(date))
            return '';
     ...
     */
    static toFormat(date, pattern, utc = false) {
        if (!this.isValidDate(date))
            return '';
        const d = date instanceof Date ? date : new Date(date);
