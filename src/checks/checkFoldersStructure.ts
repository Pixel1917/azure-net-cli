...
const getDirectories = async (dirPath: string): Promise<string[] | null> => {
	try {
...
const checkOnlyAllowedFolders = async (
	basePath: string,
	allowed: Set<string>,
	scopeLabel: string,
...
export default async function checkFoldersStructure(): Promise<void> {
