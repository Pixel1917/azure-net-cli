...
function resolveViteConfigPath(): string | null {
...
function injectEdgesImport(content: string): string {
...
function injectEdgesPlugin(content: string): string {
...
export default async function initEdges(): Promise<void> {
