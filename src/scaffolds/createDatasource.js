...
const ensureDatasourceClassName = (rawName) => {
...
const getContextChoices = async () => {
	...
	const choices = [{ title: 'core', value: 'core' }];
...
const hasResponseInterface = async (responseName) => {
...
const getConfiguredCoreAliasOrThrow = async () => {
